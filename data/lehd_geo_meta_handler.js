...
// run like this: $./lehd_geo_meta_handler.js ./lehd/pa_od_file.csv ./geo/test.dbf
//
...
var processData = function(sourceFile, geoFile) {
  ...
  var destJSON = path.dirname(sourceFile) + '/' + basename + '.json';
  ...
  // check for existence of other files
  if (fs.existsSync(destFile)) {
    ...
    CSVToBin(sourceFile, destFile, geoFile, dataClass, destJSON);
  }
}

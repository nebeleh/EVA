...
// run like this: $./twitter_handler.js ./twitter/tweets ./twitter/pitt-tweets.tsv
//
// files: output_name list_of_input_files.csv
//
// This is a special handler for Twitter dataset. The input file has two columns for date and time,
// two columns for lat and long, a categorical column for name of the region, 14 columns describing
// different moods and a final column named sum.
// I combine date and time into one value and I omit region as it is categorical.
        ...
        if (tempData.length > 0) {
          ...
          if (firstLine) {
            ...
            for (var i = 0; i < tempData.length; i++) {
              // skip over region column as it is a categorical data
              if (i == 3)
                continue;
            ...
            for (var i = 0, j = 0; i < tempData.length; i++) {
              ...
              if (i == 0)
                dummy = Date.parse(tempData[0])/100;
              else
